...
Rental marketplace frontend — tenants find বাসা ভাড়া across Bangladesh, landlords list
...
The frontend holds no JWT signing secret. `proxy.ts` only _decodes_ the access token (role and
